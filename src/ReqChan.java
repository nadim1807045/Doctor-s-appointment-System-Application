...
public class ReqChan extends javax.swing.JFrame {

    public ReqChan() {
        initComponents();
        dnam.setText(new viewDoctor().docnam);
        int x;
        x = new Channel().a;
        if(x==1){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("WELCOME   TO    SAN    HOSPITAL");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(204, 204, 204));
        jLabel2.setText("YOUR  CHANNEL  REQUEST  HAS BEEN    PROCEEDED    WITH  ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReqChan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
